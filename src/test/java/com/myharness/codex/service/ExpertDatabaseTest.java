...
class ExpertDatabaseTest {
    @Test void publishedBindingsSelectionsSnapshotsAndDownloadAuthorizationRoundTrip() throws Exception {
        ...
        tx.executeWithoutResult(status -> {
            ...
            jdbc.update("INSERT INTO agent_device(id,device_code,device_name,token_hash,status,isolation_mode,project_experts) VALUES(901,'expert-test-device','Test',REPEAT('a',64),'ONLINE','LINUX_PROJECT_SKILL_V2',1),(902,'expert-other-device','Other',REPEAT('b',64),'ONLINE','LINUX_PROJECT_SKILL_V2',1)");
