...
class ProjectServiceImplTest {
    ...
    @BeforeEach void setup() {
        ...
        AgentDevicePO device=new AgentDevicePO();device.setId(2L);device.setDeviceCode("device-2");device.setStatus("ONLINE");device.setIsolationMode("LINUX_PROJECT_SKILL_V2");
    ...
    @Test void nativeWindowsDevicePersistsItsVerifiedIsolationMode() {
        devices.selectById(2L).setIsolationMode("WINDOWS_LPAC_SKILL_V2");
