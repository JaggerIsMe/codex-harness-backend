...
class AttachmentTurnTest {
    ...
    @BeforeEach void setup() {
        ...
        device=new AgentDevicePO();device.setDeviceCode("device");device.setStatus("ONLINE");device.setIsolationMode("LINUX_PROJECT_SKILL_V2");device.setConversationAttachments(true);
