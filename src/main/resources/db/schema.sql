...
-- Managed model accounting tables are defined at the end of this file.
...
CREATE TABLE IF NOT EXISTS `agent_device` (
    ...
    `isolation_mode` VARCHAR(32) NOT NULL DEFAULT 'UNKNOWN' COMMENT 'UNKNOWN/UNSUPPORTED/LINUX_PROJECT_SKILL_V2/WINDOWS_LPAC_SKILL_V2/WINDOWS_LPAC_API_V3',
...
CREATE TABLE IF NOT EXISTS `codex_project` (
    ...
    `isolation_mode` VARCHAR(32) NOT NULL DEFAULT 'UNKNOWN' COMMENT 'Required execution isolation',
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `approval_request` (
    ...
    `decision_message_id` CHAR(36) CHARACTER SET ascii COLLATE ascii_bin NULL COMMENT 'In-flight decision command UUID; cleared on acknowledgement',
...
CREATE TABLE IF NOT EXISTS orchestration_step (
 ...
 position INT NOT NULL, name VARCHAR(80) NOT NULL, expert_id BIGINT UNSIGNED NULL,
