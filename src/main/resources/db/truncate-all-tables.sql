...
TRUNCATE TABLE `harness`.`user_quota_ledger`;
TRUNCATE TABLE `harness`.`model_usage_record`;
TRUNCATE TABLE `harness`.`user_quota_bucket`;
TRUNCATE TABLE `harness`.`user_quota_policy`;
TRUNCATE TABLE `harness`.`model_price_version`;
