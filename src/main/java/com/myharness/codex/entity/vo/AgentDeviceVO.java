...
public class AgentDeviceVO {
    ...
    private final String agentVersion; private final String osName; private final String osVersion; private final String isolationMode; private final LocalDateTime lastHeartbeatAt;
    public AgentDeviceVO(AgentDevicePO value) {
        ...
        agentVersion=value.getAgentVersion(); osName=value.getOsName(); osVersion=value.getOsVersion(); isolationMode=value.getIsolationMode(); lastHeartbeatAt=value.getLastHeartbeatAt();
    }
