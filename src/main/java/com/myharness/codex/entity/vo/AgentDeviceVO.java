...
public class AgentDeviceVO {
    ...
    private final String agentVersion; private final String osName; private final String osVersion; private final String isolationMode; private final Boolean managedModels; private final LocalDateTime lastHeartbeatAt;
    public AgentDeviceVO(AgentDevicePO value) {
        ...
        agentVersion=value.getAgentVersion(); osName=value.getOsName(); osVersion=value.getOsVersion(); isolationMode=value.getIsolationMode(); managedModels=value.getManagedModels(); lastHeartbeatAt=value.getLastHeartbeatAt();
    }
