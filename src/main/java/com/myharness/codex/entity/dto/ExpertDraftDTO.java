...
public class ExpertDraftDTO {
    ...
    private @jakarta.validation.constraints.NotNull @jakarta.validation.constraints.Size(max=0) java.util.List<String> mcpBindings = java.util.List.of();
    ...
    public java.util.List<String> getMcpBindings() { return mcpBindings; }
    public void setMcpBindings(java.util.List<String> value) { mcpBindings = value; }
