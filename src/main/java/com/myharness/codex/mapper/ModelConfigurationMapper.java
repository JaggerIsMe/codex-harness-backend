...
public interface ModelConfigurationMapper {
    ...
    @Insert("INSERT INTO device_model_assignment(device_id,model_configuration_version_id,revision,assigned_by) VALUES(#{deviceId},#{versionId},0,#{userId}) ON DUPLICATE KEY UPDATE model_configuration_version_id=VALUES(model_configuration_version_id),revision=revision+1,assigned_by=VALUES(assigned_by)") int assign(@Param("deviceId") Long deviceId,@Param("versionId") Long versionId,@Param("userId") Long userId);
